...
const Rooms = ({ match }) => {
    ...
    const {rooms, loading, error, roomsCount, resultPerPage} = 
  ...
  <Fragment>
    ...
    <select className='categoryBox' value={category} onChange={setCategoryType}>
...
<Typography>Categories</Typography>
    ...
    <select className='locationBox' value={location} onChange={setLocationType}>
      <option value=''>All</option>
       { 
    ...
    <select className='amenityBox' value={amenity} onChange={setAmenityType}>
      <option value=''>All</option>
       { 
